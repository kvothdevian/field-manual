...
| 03 | DeepSeek pay-only but near-free: V4-Flash $0.22/$0.66 per M in/out, off-peak halved (all hours except 01–04 & 06–10 UTC weekdays), cache-hit input $0.007/M; V4-Pro $0.66/$1.98; concurrency 2500/500 | https://api-docs.deepseek.com/quick_start/pricing | T1 | 2026-08 live | y | Also serves Anthropic-format endpoint /anthropic |
...
| Pages ToS boundary: NOT allowed as free commercial-business/e-commerce/SaaS hosting | https://docs.github.com/en/site-policy/github-terms/github-terms-for-additional-products-and-features | T1 | eff. 2026-04-27 | y | Also covers Actions limits |
...
| claim | URL | tier | as-of | fetched | note |
|---|---|---|---|---|---|
| Workflow taxonomy: prompt chaining, routing, parallelization (sectioning/voting), orchestrator-workers, evaluator-optimizer; simplest-thing-that-works; add complexity only when measured | anthropic.com/research/building-effective-agents | T2 | 2024-12-19 | y | Pattern-namers' own essay; points to newer Managed Agents material |
...
| Brownfield gap discussion: greenfield templates don't fit; reverse-engineering constitutions | github.com/github/spec-kit/issues/1436 | T3 | 2026-01-06 open | y | Real-world detail, unofficial status |
| Understand-before-edit: explore → plan → implement in plan mode; subagents investigate to keep main context clean; anti-pattern: infinite exploration | code.claude.com/docs/en/best-practices | T1 | current | y | Four-phase workflow |
